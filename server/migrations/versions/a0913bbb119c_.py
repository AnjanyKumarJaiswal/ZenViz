...
Revision ID: a0913bbb119c
Revises: 
Create Date: 2025-03-27 09:39:39.442853
...
def upgrade():
    ...
    sa.Column('email', sa.String(length=30), nullable=False),
    sa.Column('password', sa.String(length=12), nullable=False),
    sa.Column('reTypePassword', sa.String(length=12), nullable=False),
    sa.ForeignKeyConstraint(['loginid'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email'),
    sa.UniqueConstraint('id'),
    sa.UniqueConstraint('password'),
